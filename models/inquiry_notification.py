...
inquiry_id is nullable: a system-wide admin notification (e.g. "N
inquiries will be auto-deleted soon") isn't about any one inquiry, so it
carries inquiry_id=None. Callers rendering a notification must check
`notification.inquiry` for None before accessing it.
"""
